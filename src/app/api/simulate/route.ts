  ...
  try {
    ...
    const result = {
      ...
      steps: [
        ...
        { agent: "Authority", action: "ATTEST", detail: "EIP-191 signature over exact terms (operator-signed today)" },
        { agent: "Vault", action: "EXECUTE", detail: "1020 FXRP released from escrow" },
      ],
      outcome: {
        winner: "Agent-C",
        amount: "1020 FXRP",
        privacy: "Terms hidden until reveal. Attestation operator-signed (EIP-191). Settlement public.",
