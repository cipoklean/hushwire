...
export const AUCTION_ABI = [
  ...
  "function escrowBid(uint256 _auctionId)",
  "function settle(uint256 _auctionId)",
  "function settleAndPay(uint256 _auctionId, uint256 _settlementId, bytes _attestation)",
  "function recover(uint256 _auctionId)",
  "function getWinner(uint256 _auctionId) view returns (address winner, uint256 amount)",
  "function settleDeadline(uint256 _auctionId) view returns (uint64)",
  ...
  "function bidderEscrows(uint256, address) view returns (uint256)",
  "function recovered(uint256) view returns (bool)",
